...
(??
  (do
    (deftest
      test4clj-0
      (is (= (__ '[[A B C D] [A C D B] [B A D C] [D C A B]]) {})))
    (deftest
      test4clj-1
      (is
        (=
    ...
    (deftest
      ...
      (is
        (=
          (__ '[[A B C D] [B A D C] [D C B A] [C D A B]])
          {4 1, 2 4})))
    (deftest
      test4clj-3
      (is
        (=
          (__
            '[[B D A C B]
              ...
              [A D B C A]])
          {3 3})))
    (deftest test4clj-4 (is (= (__ [[2 4 6 3] [3 4 6 2] [6 2 4]]) {})))
    (deftest
      test4clj-5
      (is (= (__ [[1] [1 2 1 2] [2 1 2 1] [1 2 1 2] []]) {2 2})))
    (deftest
      test4clj-6
      (is (= (__ [[3 1 2] [1 2 3 1 3 4] [2 3 1 3]]) {3 1, 2 2})))
    (deftest
      test4clj-7
      (is
        (=
